...
class MempoolTransactionRequest(object):
    ...
    def __init__(self, network_identifier=None, transaction_identifier=None, local_vars_configuration=None):  # noqa: E501
        """MempoolTransactionRequest - a model defined in OpenAPI"""  # noqa: E501
