...
class ConstructionPayloadsResponse(object):
    ...
    def __init__(self, unsigned_transaction=None, payloads=None, local_vars_configuration=None):  # noqa: E501
        """ConstructionPayloadsResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def payloads(self, payloads):
        ...
        """
        if self.local_vars_configuration.client_side_validation and payloads is None:  # noqa: E501
